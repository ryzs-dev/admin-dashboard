...
export default function WhatsAppInbox() {
  ...
  const { data: msgData, loading: msgLoading } =
    useWhatsappConversationMessages(selectedId);
  ...
  const selectedConversation = convData?.conversations?.find(
              ...
              <div className="flex items-center">
                <div className="w-10 h-10 bg-gray-300 rounded-full flex items-center justify-center mr-3">
                  <span className="text-sm font-medium text-gray-600">
                    {(
                      selectedConversation?.contact?.profile_name ||
                    ...
                    >
                      ...
                      {m.message_media?.map((media: any) => (
                        <div key={media.id} className="mt-3">
                            ...
                            <div className="relative group">
                              ...
                              >
                                <div className="aspect-video w-48 bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center relative">
                                  ...
                                  >
                                    <source
                                      src={`/api/whatsapp/media/${media.media_id}#t=1`}
                                  ...
                                  <div className="absolute inset-0 flex items-center justify-center flex-col text-white">
                                    ...
                                    <span className="text-xs mt-2 bg-black/50 px-2 py-1 rounded">
                                      Video
                                    </span>
                                  </div>
                                </div>
                                ...
                                <div className="bg-green-100 rounded-full p-3 flex-shrink-0">
                                  ...
                                  >
                                    <path
                                      ...
                                      strokeLinejoin="round"
                                      strokeWidth={2}
                                      d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 14.142M5 15V9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0112.07 4h.86a2 2 0 011.664.89l.812 1.22A2 2 0 0016.07 7H17a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2z"
                                    />
                                  </svg>
                                </div>
                                <div className="flex-1 min-w-0">
                                  ...
                                  <audio controls className="w-full mt-2">
                                    <source
                                      src={`/api/whatsapp/media/${media.media_id}`}
                                      type={media.mime_type}
                                    />
                          ...
                          {preview === media.media_id && preview && (
                            <MediaPreview
                              mediaId={preview}
